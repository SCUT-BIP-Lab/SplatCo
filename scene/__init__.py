...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0], skip_train=False, skip_test=False, decompress = False, ply_path = None):
        """b
        ...
        if self.loaded_iter:
            ...
            self.gaussians.feat_planes.load_state_dict(ckpt[0],strict=False)
            self.gaussians.contractor.load_state_dict(ckpt[1],strict=False)
